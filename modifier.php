...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    do{
        ...
        if(empty($id)||empty($prenom)||empty($nom)||empty($login)||empty($mdp)||empty($email)||empty($adresse)||empty($telephone)){
        ...
        header("Location: admin.php?msg4= Etudiant modifié avec succès !");
    }while(true);
...
<form action="ajouter.php" method="POST">
    <fieldset>
    <legend>  Etudiant à modifier</legend>
    <div class="form-group">
        <label for="input1" class="col-sm-2 control-label">Prenom</label>
        <div class="col-sm-10">
            <input type="text" name="prenom"  class="form-control" id="input1"  value=" <?php echo $prenom ;?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="nom"  class="form-control" id="input1" value="  <?php echo $nom ;?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="login" class="form-control" id="input1" value=" <?php echo $login ;?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="password" name="mdp"  class="form-control" id="input1" value=" <?php echo $mdp ;?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="email" name="email"  class="form-control" id="input1" value="  <?php echo $email ;?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="adresse" class="form-control" id="input1" value="  <?php echo $adresse;?>">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" name="telephone"class="form-control" id="input1" value="   <?php echo $telephone ;?>">
