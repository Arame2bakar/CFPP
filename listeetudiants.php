...
?>
    ...
    <div class="container">
        <div class="row pt-4"> <h1>Administration CFPP</h1></div>
            <table class="table table-striped mt-3">
                ...
                <tbody>
                    <?php while ($r = $resultat->fetch()) {?>
                       <tr>
                        <td> <a href="details.php?id=<?php echo $r['Id'];?>"><?php echo $r['Id']; ?></a> </td>
						...
						<a href="modifier.php?id=<?php echo $r['Id']; ?>" class="m-2">
						 	...
						 	<div class="modal-dialog">
						 		<div class="modal-content">
						 			...
						 			<div class="modal-footer">
						 				...
						 				<a href="supprimer.php?id=<?php echo $r['Id']; ?>">
